...
<head> 
    ...
    <style type="text/css">             div 
            { 
                border-radius: 20px;                 background-color: cyan; 
                color: navy;                 padding: 30px;                 width:500px; 
...
<center> 
    ...
    <form action="response.php" method="post" > 
        <table cellpadding="10px" border="1"> 
            <tr> 
                <td>Enrolment no.:</td> 
                <td><input type="text" name="enrollment" id="enrollment" required="required" 
placeholder="Enrolment no."></td> 
            </tr> 
            <tr> 
                <td>Student name: </td> 
            ...
            <tr> 
                <td>Phone:</td> 
                <td><input type="number" name="phone" id="phone" placeholder="Phone no." 
size="12"></td> 
            </tr> 
            <tr> 
                <td>Email:</td> 
